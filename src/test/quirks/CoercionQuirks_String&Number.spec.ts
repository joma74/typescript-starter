...
describe('CoercionQuirks#String&Number', () => {
    it('#1.1 to number via any numeric operation EXCEPT +', () => {
    ...
    it('#1.2 to number via native constructor', () => {
        assert.equal(Number("3.14"), 3.14);
    });
    it('#1.3 to number via native constructor fails with NaN on non-numeric characters', () => {
        assert.ok(isNaN(Number("42px")));
    });
    it('#1.4 to number via parseInt', () => {
    ...
    it('#1.5 to number via unary operator +', () => {
        let a = "3.14";
        assert.equal(+a, 3.14);
    });
    it('#1.6.1 to number via bitwise | (ToInt32) conversion', () => {
    ...
    it('#1.6.2 to number via bitwise ~ (ToInt32) conversion', () => {
    ...
    it('#1.6.3 ~ conversion of sentinel numbers transform to appropriately boolean-coercible', () => {
        let a = "Hello World";
